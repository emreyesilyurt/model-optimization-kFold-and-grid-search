...
#cross val score
crossVal_xgb = cross_val_score(estimator = xgb, X = x_train, y = y_train, cv = 4)
print('XGB Accuracy: ', crossVal_xgb.mean())
print('XGB Std: ', crossVal_xgb.std())


crossVal_log = cross_val_score(estimator = log_reg, X = x_train, y = y_train, cv = 4)
print('Logistic Regression Accuracy: ', crossVal_log.mean())
print('Logistic Regression Std: ', crossVal_log.std())
